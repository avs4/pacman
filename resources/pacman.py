...
class Wall_W(Wall):
    def __init__(self, x, y, tile_size, map_size):
        GameObject.__init__(self, './resources/wall_w.png', x, y, tile_size, map_size)
    
class Wall_V(Wall): 
    def __init__(self, x, y, tile_size, map_size):
        GameObject.__init__(self, './resources/wall_v.png', x, y, tile_size, map_size)

class Map:
        def __init__(self, w, h):
            mapfile=open('/resources/map.txt','r')
            for x in range(map_size):
                for y in range(map_size):
                    self.map[x][y]=mapfile.read()
        
        if self.map[x][y]=='W':
            Wall_W.__init__(self, x, y, tile_size, map_size)
        elif self.map[x][y]=='V':
            Wall_V.__init__(self, x, y, tile_size, map_size)
